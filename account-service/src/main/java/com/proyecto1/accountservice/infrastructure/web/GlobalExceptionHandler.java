...
import com.proyecto1.accountservice.application.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCuentaNotFound(
        ...
        LOGGER.warn("Cuenta no encontrada: {}", exception.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleCuentaAlreadyExists(
            ...
            HttpServletRequest request) {
        LOGGER.warn("Cuenta duplicada: {}", exception.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleAmqpException(
        ...
        ErrorResponse response = ErrorResponse.of(
                status.value(),
                status.getReasonPhrase(),
                "Error de comunicación con RabbitMQ.",
                request.getRequestURI(),
                buildDetails(exception));
    ...
    public ResponseEntity<ErrorResponse> handleInsufficientBalance(
            ...
            HttpServletRequest request) {
        LOGGER.warn("Saldo insuficiente: {}", exception.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleInactiveAccount(
            ...
            HttpServletRequest request) {
        LOGGER.warn("Cuenta inactiva: {}", exception.getMessage());
    ...
    @ExceptionHandler(InvalidMovementValueException.class)
    public ResponseEntity<ErrorResponse> handleInvalidMovementValue(
            InvalidMovementValueException exception,
            HttpServletRequest request) {
        LOGGER.warn("Movimiento inválido: {}", exception.getMessage());
